...
Namespace Models
    Partial Public Class NorthContext
        ...
        Public Sub New(options As DbContextOptions(Of NorthContext))
            MyBase.New(options)
        End Sub
        ...
        Protected Overrides Sub OnModelCreating(modelBuilder As ModelBuilder)
            ...
            modelBuilder.Entity(Of Categories)(
                Sub(entity)
            ...
            modelBuilder.Entity(Of Customers)(
                Sub(entity)
                    ...
                    entity.Property(Function(e) e.CustomerId).
                                                 ...
                                                 HasMaxLength(5).ValueGeneratedNever()
                    ...
                    entity.HasOne(
                        Function(d) d.ContactTitleNavigation).
                                                 WithMany(Function(p) p.Customers).
                                                 HasForeignKey(Function(d) d.ContactTitleId).
                                                 HasConstraintName("ContactTitleCustomers")
                End Sub)

            modelBuilder.Entity(Of CustomersContactTitle)(
                Sub(entity)
            ...
            modelBuilder.Entity(Of Employees)(
                Sub(entity)
            ...
            modelBuilder.Entity(Of Orders)(
                Sub(entity)
                    ...
                    entity.Property(Function(e) e.CustomerIdOld).
                    ...
                    entity.HasOne(Function(d) d.CustomerIdOldNavigation).
                                              WithMany(Function(p) p.Orders).
                                              HasForeignKey(Function(d) d.CustomerIdOld).
            ...
            modelBuilder.Entity(Of Products)(
                Sub(entity)
                    ...
                    entity.HasOne(Function(d) d.Category).
                                                ...
                                                HasForeignKey(Function(d) d.CategoryId).
                                                HasConstraintName("CategoriesProducts")
                End Sub)

            modelBuilder.Entity(Of Suppliers)(
                Sub(entity)
                    ...
                    entity.HasOne(Function(d) d.SuppliersTitle).
                                                 WithMany(Function(p) p.Suppliers).
                                                 HasForeignKey(Function(d) d.SuppliersTitleId).
                                                 HasConstraintName("SuppliersContactTitleSuppliers")
                End Sub)

            modelBuilder.Entity(Of SuppliersContactTitle)(
                Sub(entity)
